  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        ...
        description: "Join teams building powerful email campaigns",
      ...
      helperText: (
        <>
          ...
          <button
            ...
            className="text-primary hover:underline font-medium"
          >
            Create one to start forging campaigns.
          </button>
        </>
      ),
    };
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Powerful, collaborative email marketing made simple.
              </h1>
        ...
        <div className="flex min-h-[720px] items-center justify-center p-4 sm:p-8 lg:p-10">
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center text-sm mt-4">{content.helperText}</div>
            </CardContent>
          </Card>
        </div>
      </section>
